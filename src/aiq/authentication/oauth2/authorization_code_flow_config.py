...
class OAuth2AuthorizationCodeFlowConfig(AuthenticationBaseConfig, name="oauth2_authorization_code"):
    ...
    token_endpoint_auth_method: str | None = Field(description="The authentication method for the token endpoint.",
                                                   default=None)
    scope: list[str] = Field(description="The space-delimited scopes for OAuth 2.0 authentication.",
    ...
    audience: str | None = Field(default=None, description="The audience for which the access token is intended.")
